/*
  ...
  - Added the required column `flightPrice` to the `flights` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_flights" ("aircraftCode", "arrivalTime", "boardingEndingTime", "boardingTime", "createdAt", "finishBookingTime", "flightTime", "gate", "id", "routeId", "terminal", "updatedAt") SELECT "aircraftCode", "arrivalTime", "boardingEndingTime", "boardingTime", "createdAt", "finishBookingTime", "flightTime", "gate", "id", "routeId", "terminal", "updatedAt" FROM "flights";
DROP TABLE "flights";
